      SUBROUTINE SOLARM(TF,LAST,FNC,NST)
...
C-kb Line added
     ...
     &   KAPPALAYERSOL_H2O !EWS - BETA not used 9/4/2015
...
!     & ,kmatrix_sol(NSOL,IK) ! c-rr Added weightco2_h2O data array and weights array that combines co2_h2o and Ch4 weight arrays 3/19/2012! c-rr Added 16 weight coefficient array for CO2-H2O kspectrum mixed absorption coefficiets, 3/15/2012
     ...
     & CPN(ND), CPNT(ND)
      ...
      DIMENSION  TAUAS(ND-1),TAUS(ND-1), !EWS TAUA(ND-1) not used 9/4/2015
     ...
     &  SOLAV(NSOL+1) ! Added solar intervals
      DIMENSION TAUCONTSOL(ND),  ! Added water continuum tau for solar 8/30/2012 !EWS - removed W(NF), AVOLD(NF) - not used
...
!               END IF
     ...
     &             weights(3,I,K3)  ! Convolve H2O, CO2 & CH4
