...
C-kb *** The edits made in this subroutine (addition of a single line
C-kb that calls a new subroutine READSOLG) enable additional data to be
C-kb read in to set the user-specified spectral wavelength ranges and
C-kb the parameters for calculating the photosynthetic rates. ***
